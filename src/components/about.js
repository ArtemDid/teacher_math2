            ...
            <Content className='about'>
                ...
                <div class="d-flex flex-column bd-highlight mb-3" style={{ fontSize: '18px' }}>
                    ...
                    <div class="p-2 bd-highlight">
                        ...
                        <div style={{ textAlign: 'center', fontFamily: 'Pattaya', fontSize: 36, color: 'blue', textShadow: '0 0 20px rgba(0,0,0,0.8)' }}>"Мої учні будуть дізнаватися про нове не від мене; вони будуть відкривати це нове самостійно.
                        Моя основна задача - допомогти їм розкритися". М. Песталоцці</div>
                    </div>
                    <div class="p-2 bd-highlight">
                        ...
                        <i style={{ marginLeft: '10px' }}>2) Грамота управління освітою Оріхівської райдержадміністрації за багаторічну сумлінну працю і вагомий внесок у справі навчання і виховання учнів, 26.09.2016 р.</i><br />
                        <i style={{ marginLeft: '10px' }}>3) Грамота відділу освіти Комишуваської селищної ради Оріхівського району Запорізької області "За сумлунну працю, високий професіоналізм, вагомий внесок у справу навчання і виховання підростаючого покоління та з нагоди Дня працівників освіти" 2020р.</i><br />
                        <i style={{ marginLeft: '10px' }}>4) Подяка від проекту "Всеосвіта" за вміння збирати, опрацювати, зберігати і розповсюджувати інформацію, яка є корисною для освітнього процесу та вагомий внесок у розвиток найбільшої в Украйні онлайн-бібліотеки митоличних матеріалів. 2020р.</i>
                    ...
                    <div class="p-2 bd-highlight">
                        ...
                        <i style={{ marginLeft: '10px' }}>«Формування та розвиток математичних компетентностей учнів на уроках математики»</i>
                    </div>
                    <br />
                    <div class="p-2 bd-highlight">
